   ...
   <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4
    text-slate-700'>
      ...
      border-gray-200'>
         ...
         border border-gray-300' placeholder='Enter a scene, style, or idea to generate an image...' required/>
         ...
         <div className='mt-3 flex gap-3 flex-wrap sm:max-w-9/11'>
          ...
          <div className='my-6 flex items-center gap-2'>
            <label className='realtive cursor-pointer'>
            ...
            <p className='text-sm'>Upload in Community</p>
          </div>
         ...
         border-gray-200 min-h-96'>
          ...
          <div className='flex-1 flex justify-center items-center'>
            ...
            text-gray-400'>
              ...
              <p>Enter a topic and click "Generate Image" to get Image</p>
            </div>
          </div>
