    ...
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4
        text-slate-700'>
          ...
          border-gray-200'>
             ...
             accept='image/*' className='w-full p-2 px-3 mt-2 outline-none text-sm rounded-md
             border border-gray-300 text-gray-600' required/>

              <p className='mt-6 text-sm font-medium'>Describe name of object to remove.</p>
             ...
             border-gray-200 min-h-96'>
              ...
              <div className='flex-1 flex justify-center items-center'>
                ...
                text-gray-400'>
                  ...
                  <p>Upload an image and click "Remove Object" to get Remove Object</p>
                </div>
              </div>
