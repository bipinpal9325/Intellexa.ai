const Testimonial = () => {
    ...
    const CreateCard = ({ card }) => (
        <div className="p-3 rounded-lg mx-2 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
            ...
            <p className="text-sm py-2 text-gray-800">{card.comment}</p>
        </div>
    );
